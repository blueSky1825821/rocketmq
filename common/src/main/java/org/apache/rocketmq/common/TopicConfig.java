...
public class TopicConfig {
    ...
    /**
     * 读写队列在路由信息时使用，发送消息时，使用写队列个数返回路由信息，而消息消费时按照读队列个数返回路由信息。
     * 在物理文件层面只有写队列才会创建文件。
     * 最佳实践是readQueueNums=writeQueueNums
     * 方便扩容缩容100%不丢失消息:
     * 先缩容写队列128->64，写队列由0 1 2 ......127缩至 0 1 2 ........63。等到64 65 66......127中的消息全部消费完后，再缩容读队列128->64
     *
     * @link: https://blog.csdn.net/qian_348840260/article/details/108975241
     */
